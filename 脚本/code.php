...
function generateService($tablename, $table){
	...
	$string .= tab(1)."boolean add".ucfirst($tablename)."(".ucfirst($tablename)." ".lcfirst($tablename).");".rn(2);
	$string .= tab(1)."boolean edit".ucfirst($tablename)."(".ucfirst($tablename)." ".lcfirst($tablename).");".rn(2);
	$string .= tab(1)."boolean del".ucfirst($tablename)."(List<Integer> ids);".rn(2);
...
function generateServiceImpl($tablename, $table){
	...
	$string .= tab(1)."public boolean edit".ucfirst($tablename)."(".ucfirst($tablename)." ".lcfirst($tablename).") {".rn(1);
	...
	$string .= tab(1)."}".rn(2);
	$string .= tab(1)."@Override".rn(1);
	$string .= tab(1)."public boolean add".ucfirst($tablename)."(".ucfirst($tablename)." ".lcfirst($tablename).") {".rn(1);
	$string .= tab(2)."// TODO Auto-generated method stub".rn(1);
	$string .= tab(2)."return this.".$tablename."Dao.add".ucfirst($tablename)."(".lcfirst($tablename).");".rn(1);
	$string .= tab(1)."}".rn(2);
	$string .= tab(1)."@Override".rn(1);
	$string .= tab(1)."public boolean del".ucfirst($tablename)."(List<Integer> ids) {".rn(1);
	$string .= tab(2)."// TODO Auto-generated method stub".rn(1);
...
function generateMapper($tablename, $table){
	...
	$string .= tab(1)."<select id=\"findAll\" resultMap=\"BaseResultMap, ".lcfirst(convertUnderline2($tablename))."RecordCounts\">".rn(1);
...
function generateController($tablename, $table){
	...
	$string .= tab(2)."ArrayList<".ucfirst($tablename)."> ".lcfirst($tablename)."s = new ArrayList<".ucfirst($tablename).">();".rn(1);
	$string .= tab(2)."long total = 0;".rn(1);
	$string .= tab(2)."result".$tablename."s = (ArrayList<Object>)".lcfirst($tablename)."Service.findAll(".lcfirst($tablename).", page_start, page_length);".rn(1);
	...
	$string .= tab(2)."JSONObject result = new JSONObject();".rn(1);
	$string .= tab(3)."Boolean r = ".lcfirst($tablename)."Service.add".ucfirst($tablename)."(".lcfirst($tablename).");".rn(1);
	$string .= tab(3)."result.put(\"success\", r);".rn(1);
	$string .= tab(2)."return result;".rn(1);
	$string .= tab(1)."}".rn(2);
	...
	$string .= tab(2)."JSONObject result = new JSONObject();".rn(1);
	$string .= tab(3)."Boolean r = ".lcfirst($tablename)."Service.edit".ucfirst($tablename)."(".lcfirst($tablename).");".rn(1);
	$string .= tab(3)."result.put(\"success\", r);".rn(1);
	$string .= tab(2)."return result;".rn(1);
	$string .= tab(1)."}".rn(2);
	...
	$string .= tab(2)."result.accumulate(\"success\", true);".rn(1);
	$string .= tab(2)."if(_ids.isEmpty()) {".rn(1);
	$string .= tab(3)."result.accumulate(\"success\", false);".rn(1);
	$string .= tab(3)."result.accumulate(\"msg\", \"id不能为空\");".rn(1);
	$string .= tab(2)."}".rn(1);
	$string .= tab(3)."Boolean r = ".lcfirst($tablename)."Service.del".ucfirst($tablename)."(_ids);".rn(1);
	$string .= tab(3)."result.accumulate(\"success\", r);".rn(1);
	$string .= tab(2)."return result;".rn(1);
	$string .= tab(1)."}".rn(1);
	$string .= tab(0)."}".rn(1);
